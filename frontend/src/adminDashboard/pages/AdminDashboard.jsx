  ...
  return (
    <div className="h-[100dvh] w-full flex bg-white overflow-hidden m-0 p-0">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white shadow-md px-4 py-3 flex items-center justify-between md:hidden flex-shrink-0 pt-[env(safe-area-inset-top,12px)]">
          <h1 className="text-base sm:text-lg font-bold truncate pr-2" style={{ color: '#e9931c' }}>
            Admin Dashboard
          </h1>
          <button
            onClick={handleLogout}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm flex-shrink-0 shadow-sm"
          >
