...
import { FaFileInvoice, FaSearch, FaCheckSquare, FaPlus, FaEdit, FaTrash, FaEye, FaQrcode, FaPaperPlane, FaDownload, FaWhatsapp, FaCloudUploadAlt, FaFileImport, FaFilePdf } from 'react-icons/fa'
...
const Quotes = ({ initialFilter, onFilterConsumed }) => {
  ...
  const handleSendQuoteWhatsApp = (quote) => {
    ...
    // Pakistan 0xxx -> 92xxx; 10 digits -> 92; already has country code (92/44) keep as is
    let num = phone
