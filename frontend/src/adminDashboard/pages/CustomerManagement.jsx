  ...
  return (
    <div className="w-full">
      ...
      {loading && customers.length === 0 ? (
        ...
        <div className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden flex flex-col min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] h-[500px] sm:h-[600px] lg:h-[calc(100vh-300px)]">
          {useMemo(() => {
      ...
      {showCustomerDetailModal && selectedCustomer && (
        <div className="fixed inset-0 bg-white sm:bg-black/60 flex items-start sm:items-center justify-center z-[9999] p-0 sm:p-4 md:p-5 overflow-hidden sm:overflow-y-auto min-h-[100dvh]">
          <div className="bg-white w-full h-[100dvh] sm:h-auto sm:max-w-7xl sm:max-h-[90vh] sm:rounded-2xl shadow-2xl flex flex-col pt-[env(safe-area-inset-top)] sm:pt-0 pb-[env(safe-area-inset-bottom)] sm:pb-0">
            {/* Modal Header */}
